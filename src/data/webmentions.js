...
/*
** SOURCE: https://mxb.dev/blog/persistent-build-folders-netlify/
*/
const fs = require('fs');
const fetch = require('node-fetch');
const unionBy = require('lodash/unionBy');
const domain = require('./site.js').paths.domain;
...
async function fetchWebmentions(since, perPage = 10000) {
    if (!domain) {
        ...
        console.warn(
            '>>> unable to fetch webmentions: no domain name specified in site config.'
        );
        return false;
    }
